...
static void InitDefaultsscc_info_RpcMessage_rpc_2eproto() {
  ...
  {
    void* ptr = &::QE::net::_RpcMessage_default_instance_;
    new (ptr) ::QE::net::RpcMessage();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::QE::net::RpcMessage::InitAsDefaultInstance();
}
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpc_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, type_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, id_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, service_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, method_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, request_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, response_),
  PROTOBUF_FIELD_OFFSET(::QE::net::RpcMessage, error_),
  6,
  4,
  0,
  1,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, sizeof(::QE::net::RpcMessage)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::QE::net::_RpcMessage_default_instance_),
};

const char descriptor_table_protodef_rpc_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\trpc.proto\022\006QE.net\"\241\001\n\nRpcMessage\022!\n\004ty"
  "pe\030\001 \002(\0162\023.QE.net.MessageType\022\n\n\002id\030\002 \002("
  "\006\022\017\n\007service\030\003 \001(\t\022\016\n\006method\030\004 \001(\t\022\017\n\007re"
  "quest\030\005 \001(\014\022\020\n\010response\030\006 \001(\014\022 \n\005error\030\007"
  " \001(\0162\021.QE.net.ErrorCode*3\n\013MessageType\022\013"
...
RpcMessage::RpcMessage(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:QE.net.RpcMessage)
}
RpcMessage::RpcMessage(const RpcMessage& from)
  ...
  // @@protoc_insertion_point(copy_constructor:QE.net.RpcMessage)
}
...
RpcMessage::~RpcMessage() {
  // @@protoc_insertion_point(destructor:QE.net.RpcMessage)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:QE.net.RpcMessage)
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          ...
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::QE::net::MessageType_IsValid(val))) {
            _internal_set_type(static_cast<::QE::net::MessageType>(val));
          } else {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "QE.net.RpcMessage.service");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "QE.net.RpcMessage.method");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      ...
      case 7:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 56)) {
          ::PROTOBUF_NAMESPACE_ID::uint64 val = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
          if (PROTOBUF_PREDICT_TRUE(::QE::net::ErrorCode_IsValid(val))) {
            _internal_set_error(static_cast<::QE::net::ErrorCode>(val));
          } else {
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:QE.net.RpcMessage)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:QE.net.RpcMessage)
  return target;
}

size_t RpcMessage::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:QE.net.RpcMessage)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:QE.net.RpcMessage)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:QE.net.RpcMessage)
  GOOGLE_DCHECK_NE(&from, this);
  const RpcMessage* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<RpcMessage>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:QE.net.RpcMessage)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:QE.net.RpcMessage)
    MergeFrom(*source);
  }
}

void RpcMessage::MergeFrom(const RpcMessage& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:QE.net.RpcMessage)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:QE.net.RpcMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:QE.net.RpcMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::QE::net::RpcMessage* Arena::CreateMaybeMessage< ::QE::net::RpcMessage >(Arena* arena) {
  return Arena::CreateMessageInternal< ::QE::net::RpcMessage >(arena);
}
