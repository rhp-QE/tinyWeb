...
PROTOBUF_NAMESPACE_OPEN
template<> ::QE::net::RpcMessage* Arena::CreateMaybeMessage<::QE::net::RpcMessage>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace QE {
namespace net {
...
class RpcMessage PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:QE.net.RpcMessage) */ {
 public:
  ...
  // optional .QE.net.ErrorCode error = 7;
  bool has_error() const;
  private:
  bool _internal_has_error() const;
  public:
  void clear_error();
  ::QE::net::ErrorCode error() const;
  void set_error(::QE::net::ErrorCode value);
  private:
  ::QE::net::ErrorCode _internal_error() const;
  void _internal_set_error(::QE::net::ErrorCode value);
  public:

  // required .QE.net.MessageType type = 1;
  bool has_type() const;
  private:
  bool _internal_has_type() const;
  public:
  void clear_type();
  ::QE::net::MessageType type() const;
  void set_type(::QE::net::MessageType value);
  private:
  ::QE::net::MessageType _internal_type() const;
  void _internal_set_type(::QE::net::MessageType value);
  public:

  // @@protoc_insertion_point(class_scope:QE.net.RpcMessage)
 private:
  class _Internal;
...
inline ::QE::net::MessageType RpcMessage::_internal_type() const {
  return static_cast< ::QE::net::MessageType >(type_);
}
inline ::QE::net::MessageType RpcMessage::type() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.type)
  return _internal_type();
}
inline void RpcMessage::_internal_set_type(::QE::net::MessageType value) {
  assert(::QE::net::MessageType_IsValid(value));
  _has_bits_[0] |= 0x00000040u;
  type_ = value;
}
inline void RpcMessage::set_type(::QE::net::MessageType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.type)
}
...
inline ::PROTOBUF_NAMESPACE_ID::uint64 RpcMessage::id() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.id)
  return _internal_id();
}
...
inline void RpcMessage::set_id(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  ...
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.id)
}
...
inline const std::string& RpcMessage::service() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.service)
  return _internal_service();
}
inline void RpcMessage::set_service(const std::string& value) {
  _internal_set_service(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.service)
}
inline std::string* RpcMessage::mutable_service() {
  // @@protoc_insertion_point(field_mutable:QE.net.RpcMessage.service)
...
inline void RpcMessage::set_service(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:QE.net.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value) {
  ...
  service_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:QE.net.RpcMessage.service)
}
inline void RpcMessage::set_service(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:QE.net.RpcMessage.service)
}
...
inline std::string* RpcMessage::release_service() {
  // @@protoc_insertion_point(field_release:QE.net.RpcMessage.service)
...
inline void RpcMessage::set_allocated_service(std::string* service) {
  ...
  service_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), service,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:QE.net.RpcMessage.service)
}
inline std::string* RpcMessage::unsafe_arena_release_service() {
  // @@protoc_insertion_point(field_unsafe_arena_release:QE.net.RpcMessage.service)
...
inline void RpcMessage::unsafe_arena_set_allocated_service(
  ...
  service_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      service, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:QE.net.RpcMessage.service)
}
...
inline const std::string& RpcMessage::method() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.method)
  return _internal_method();
}
inline void RpcMessage::set_method(const std::string& value) {
  _internal_set_method(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.method)
}
inline std::string* RpcMessage::mutable_method() {
  // @@protoc_insertion_point(field_mutable:QE.net.RpcMessage.method)
...
inline void RpcMessage::set_method(std::string&& value) {
  ...
  method_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:QE.net.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value) {
  ...
  method_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:QE.net.RpcMessage.method)
}
inline void RpcMessage::set_method(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  method_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:QE.net.RpcMessage.method)
}
...
inline std::string* RpcMessage::release_method() {
  // @@protoc_insertion_point(field_release:QE.net.RpcMessage.method)
...
inline void RpcMessage::set_allocated_method(std::string* method) {
  ...
  method_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), method,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:QE.net.RpcMessage.method)
}
inline std::string* RpcMessage::unsafe_arena_release_method() {
  // @@protoc_insertion_point(field_unsafe_arena_release:QE.net.RpcMessage.method)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000002u;
...
inline void RpcMessage::unsafe_arena_set_allocated_method(
  ...
  method_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      method, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:QE.net.RpcMessage.method)
}
...
inline const std::string& RpcMessage::request() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.request)
  return _internal_request();
}
inline void RpcMessage::set_request(const std::string& value) {
  _internal_set_request(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.request)
}
inline std::string* RpcMessage::mutable_request() {
  // @@protoc_insertion_point(field_mutable:QE.net.RpcMessage.request)
...
inline void RpcMessage::set_request(std::string&& value) {
  ...
  request_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:QE.net.RpcMessage.request)
}
inline void RpcMessage::set_request(const char* value) {
  ...
  request_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:QE.net.RpcMessage.request)
}
inline void RpcMessage::set_request(const void* value,
  ...
  request_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:QE.net.RpcMessage.request)
}
...
inline std::string* RpcMessage::release_request() {
  // @@protoc_insertion_point(field_release:QE.net.RpcMessage.request)
...
inline void RpcMessage::set_allocated_request(std::string* request) {
  ...
  request_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), request,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:QE.net.RpcMessage.request)
}
inline std::string* RpcMessage::unsafe_arena_release_request() {
  // @@protoc_insertion_point(field_unsafe_arena_release:QE.net.RpcMessage.request)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000004u;
...
inline void RpcMessage::unsafe_arena_set_allocated_request(
  ...
  request_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      request, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:QE.net.RpcMessage.request)
}
...
inline const std::string& RpcMessage::response() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.response)
  return _internal_response();
}
inline void RpcMessage::set_response(const std::string& value) {
  _internal_set_response(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.response)
}
inline std::string* RpcMessage::mutable_response() {
  // @@protoc_insertion_point(field_mutable:QE.net.RpcMessage.response)
...
inline void RpcMessage::set_response(std::string&& value) {
  ...
  response_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:QE.net.RpcMessage.response)
}
inline void RpcMessage::set_response(const char* value) {
  ...
  response_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:QE.net.RpcMessage.response)
}
inline void RpcMessage::set_response(const void* value,
  ...
  response_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:QE.net.RpcMessage.response)
}
...
inline std::string* RpcMessage::release_response() {
  // @@protoc_insertion_point(field_release:QE.net.RpcMessage.response)
...
inline void RpcMessage::set_allocated_response(std::string* response) {
  ...
  response_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), response,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:QE.net.RpcMessage.response)
}
inline std::string* RpcMessage::unsafe_arena_release_response() {
  // @@protoc_insertion_point(field_unsafe_arena_release:QE.net.RpcMessage.response)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000008u;
...
inline void RpcMessage::unsafe_arena_set_allocated_response(
  ...
  response_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      response, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:QE.net.RpcMessage.response)
}
...
inline ::QE::net::ErrorCode RpcMessage::_internal_error() const {
  return static_cast< ::QE::net::ErrorCode >(error_);
}
inline ::QE::net::ErrorCode RpcMessage::error() const {
  // @@protoc_insertion_point(field_get:QE.net.RpcMessage.error)
  return _internal_error();
}
inline void RpcMessage::_internal_set_error(::QE::net::ErrorCode value) {
  assert(::QE::net::ErrorCode_IsValid(value));
  _has_bits_[0] |= 0x00000020u;
  error_ = value;
}
inline void RpcMessage::set_error(::QE::net::ErrorCode value) {
  _internal_set_error(value);
  // @@protoc_insertion_point(field_set:QE.net.RpcMessage.error)
}
...
template <> struct is_proto_enum< ::QE::net::MessageType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::QE::net::MessageType>() {
  return ::QE::net::MessageType_descriptor();
}
template <> struct is_proto_enum< ::QE::net::ErrorCode> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::QE::net::ErrorCode>() {
  return ::QE::net::ErrorCode_descriptor();
}
